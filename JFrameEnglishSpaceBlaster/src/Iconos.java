...
public class Iconos {
     ...
     * 
     */
    public Iconos(int iX, int iY ,Image imaImagen) {
        this.iX = iX;
        this.iY = iY;
     ...
     * 
     */
    public Iconos(int iX, int iY ,ImageIcon icoImagen) {
        this.iX = iX;
        this.iY = iY;
        imiIcono = icoImagen;
    }
     ...
     * colisiona
     * 
     * Metodo para revisar si un objeto <code>Iconos</code> colisiona con otro
     * esto se logra con un objeto temporal de la clase <code>Rectangle</code>
     * 
     * @param aniObjeto es el objeto <code>Iconos</code> con el que se compara
     * @return  un valor true si esta colisionando y false si no
     * 
     */
    public boolean colisiona(Iconos aniParametro) {
        // creo un objeto rectangulo a partir de este objeto Iconos
        Rectangle recObjeto = new Rectangle(this.getX(),this.getY(),
                this.getAncho(), this.getAlto());
        
        // creo un objeto rectangulo a partir del objeto Iconos parametro
     ...
     * colisiona
     * 
     * Metodo para revisar si un objeto <code>Iconos</code> colisiona con una
